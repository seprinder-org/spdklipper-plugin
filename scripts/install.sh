...
# Main functions
init_config_path() {
  report_status "Using default config path: ${KLIPPER_CONF_DIR}"
...
create_initial_config() {
  ...
  create_service
  ok_msg "SPDKlipper plugin instance created!"
}
...
setup_dialog(){
    report_status "Starting SPDKlipper plugin installation..."
    echo ""
    install_instances
}
